...
Output folder structure mirrors the QUID script but with "depo_" prefix:
  ...
  depo_runs/
    └── depo_quid_qdetection_AZ23_angle_l5_summary.csv
============================================================
"""
...
DEPO_SUMMARY_CSV = os.path.join(DEPO_RUN_DIR, "depo_quid_qdetection_AZ23_angle_l5_summary.csv")
