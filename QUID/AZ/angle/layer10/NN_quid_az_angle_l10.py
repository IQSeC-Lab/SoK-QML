...
Model architecture (identical to NN_angle_AZ_LF_l10.py):
...
# ============================================================
# 7. train() and test() — match NN_angle_AZ_LF_l10.py exactly
# ============================================================
...
# ============================================================
# 8. evaluation() — matches NN_angle_AZ_LF_l10.py exactly
# ============================================================
...
def save_per_run_csv(metrics, filepath):
    """['Metric','Value'] format — matches NN_angle_AZ_LF_l10.py."""
