...
Output folder structure mirrors the QUID script but with "depo_" prefix:
  depo_eps0.1/  depo_eps0.3/  depo_eps0.5/
    ├── depo-qmlp-az-quid-run{r}-layer50_quid_eps{e}_{attack}_{def}.csv
    └── depo-qmlp-az-quid-run{r}-layer50_quid_eps{e}_{attack}_{def}_cm.png
  depo_runs/
    └── depo_quid_qdetection_AZ23_amplitude_l50_summary.csv
