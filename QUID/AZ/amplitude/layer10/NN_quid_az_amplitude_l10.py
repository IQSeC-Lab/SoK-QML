"""
QUID_QDetection_AZ23_Amplitude_l10.py
============================================================
Combines:
...
Optimisations over naive implementation:
  ...
  2. MULTI-GPU PARALLEL EXPERIMENTS
     ...
     GPUs are used, e.g.:
       CUDA_VISIBLE_DEVICES=0,1,2,3 python QUID_QDetection_AZ23_Amplitude_l10.py

Model architecture (identical to NN_AZ_amplitude_l10_LF.py):
...
Output folder structure:
  ...
  runs/
    └── quid_qdetection_AZ23_amplitude_summary.csv
...
SUMMARY_CSV = os.path.join(RUN_DIR, "quid_qdetection_AZ23_amplitude_l10_summary.csv")
...
def main():
    print("=" * 68)
    print(" QUID + Q-Detection | AZ-Class 23-family | 9-qubit Amplitude model (PCA->512) | 10 layers")
