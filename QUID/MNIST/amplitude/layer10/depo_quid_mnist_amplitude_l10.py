"""
depo_quid_mnist_amplitude_l10.py
============================================================
Depolarizing-noise evaluation of models saved by NN_quid_mnist_amplitude_l2.py.
...
Output folder structure mirrors the QUID script but with "depo_" prefix:
  ...
  depo_runs/
    └── depo_quid_qdetection_MNIST_amplitude_l10_summary.csv
============================================================
"""
...
# ============================================================
# Config — must match NN_quid_mnist_amplitude_l2.py exactly
# ============================================================
N_QUBITS   = 9
N_LAYERS   = 10
N_CLASSES  = 10
...
#    AmplitudeEmbedding applied ONCE + broadcast_expand for batches
...
class QMLPMNIST(nn.Module):
    """Same architecture as NN_quid_mnist_amplitude_l2.py but with noisy device."""
    def __init__(self):
        super().__init__()
...
# ============================================================
# 3. Data — must match NN_quid_mnist_amplitude_l2.py exactly
#    flatten(28x28) -> MinMaxScaler -> PCA(512)
...
# ============================================================
# 4. Poisoning replay — identical to NN_quid_mnist_amplitude_l2.py
...
def main():
    print("=" * 68)
    print(f" Depolarizing Noise Evaluation | QUID MNIST-Amplitude L{N_LAYERS} | p={DEPO_P}")
    ...
    if not os.path.exists(RHO_PROTO_CACHE_FILE):
        raise FileNotFoundError(
            ...
            f"Run NN_quid_mnist_amplitude_l2.py first to build it.")
