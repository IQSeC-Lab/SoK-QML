"""
NN_quid_mnist_amplitude_l10.py
============================================================
Combines:
...
Optimisations over naive implementation:
  ...
  2. MULTI-GPU PARALLEL EXPERIMENTS
     ...
     GPUs are used, e.g.:
       CUDA_VISIBLE_DEVICES=0,1,2,3 python NN_quid_mnist_amplitude_l10.py
...
Output folder structure:
  ...
  runs/
    └── quid_qdetection_mnist_amplitude_l10_summary.csv
...
SUMMARY_CSV = os.path.join(RUN_DIR, "quid_qdetection_mnist_amplitude_l10_summary.csv")
