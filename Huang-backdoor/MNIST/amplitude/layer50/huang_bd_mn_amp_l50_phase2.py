...
def make_device():
    ...
    causing a silent hang or broadcasting error.
    default.qubit uses backprop which handles this correctly.
    """
...
def main():
    ...
    print("\n" + "="*68)
    print(" PHASE 1 — Loading existing proxy from huang_proxy_best.pt")
    print("="*68)
