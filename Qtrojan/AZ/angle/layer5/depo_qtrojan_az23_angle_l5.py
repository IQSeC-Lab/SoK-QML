"""
depo_qtrojan_az23_angle_l5.py
============================================================
Depolarizing-noise evaluation of models saved by
qtrojan_az23_angle_l5.py.
...
Source model path:
  qtrojan/qtrojan_az23-layer5_noiseless_Angle_best.pt

Output folder structure:
  depo_qtrojan/
    ├── depo_qtrojan_az23_layer5_noiseless_Angle_metrics.csv
    └── depo_qtrojan_az23_layer5_noiseless_Angle_cm.png
  depo_runs/
...
# ============================================================
# Config — must match qtrojan_az23_angle_l5.py exactly
# ============================================================
N_QUBITS   = 9
N_LAYERS   = 5
N_CLASSES  = 23
...
# Source model — saved by qtrojan_az23_angle_l5.py
...
# ============================================================
# 3. Data — must match qtrojan_az23_angle_l5.py exactly
# ============================================================
def load_az23_pca9(
...
def main():
    ...
    if not os.path.exists(SOURCE_MODEL_PATH):
        raise FileNotFoundError(
            ...
            f"Run qtrojan_az23_angle_l5.py first.")
