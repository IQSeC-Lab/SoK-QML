"""
depo_qtrojan_mnist_angle_l2.py
============================================================
Depolarizing-noise evaluation of models saved by
qtrojan_mnist_angle_l2.py.
...
Dataset / preprocessing — matches qtrojan_mnist_angle_l2.py exactly:
  * MNIST 10-class
  * downscale(3×3) → flatten → MinMaxScaler → PCA(9)

Source model path:
  qtrojan/qtrojan-layer2_noiseless_Angle_best.pt

Output folder structure:
  depo_qtrojan/
    ├── depo_qtrojan_mnist_layer2_noiseless_Angle_metrics.csv
    └── depo_qtrojan_mnist_layer2_noiseless_Angle_cm.png
  depo_runs/
...
# ============================================================
# Config — must match qtrojan_mnist_angle_l2.py exactly
# ============================================================
N_QUBITS   = 9
N_LAYERS   = 2
N_CLASSES  = 10
...
# Source model — saved by qtrojan_mnist_angle_l2.py
...
# ============================================================
# 3. Data — must match qtrojan_mnist_angle_l2.py exactly
# ============================================================
...
def main():
    ...
    if not os.path.exists(SOURCE_MODEL_PATH):
        raise FileNotFoundError(
            ...
            f"Run qtrojan_mnist_angle_l2.py first.")
