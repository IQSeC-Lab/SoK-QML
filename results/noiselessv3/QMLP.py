...
for run_id  in range (1,4):
    ...
    best_model = f'{best_model_prefix}{run_id}.pt'
...
for run_id in range (1,4):
    best_model = f'{best_model_prefix}{run_id}.pt'
    cm_name = f'{cm_name_prefix}{run_id}.png'
    filename = f'{filename_prefix}_runs.csv' 
    if os.path.exists(best_model):
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(f"qcnn_fgsm_accuracy_plot_{run_id}.png", dpi=300)
