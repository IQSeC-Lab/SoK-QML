...
best_model_prefix = "qmlp-EMBER-run"
cm_name_prefix= "cm_qmlp-EMBER-run"
filename_prefix = "qmlp-EMBER-run"
noise_afterfix = ""
...
data_train = np.load("../datasets/EMBER2018/XY_train.npz") 
data_test = np.load("../datasets/EMBER2018/XY_test.npz") 
# Ember and AZ
