...
Saved model expected (from NN_baseline_mnist_angle_layer10.py):
  baseline_mnist_angle_layer10/best_model_run1.pt
...
Output folder structure:
  ...
  depo_baseline_runs/
    depo_baseline_mn_ang_l10_summary.csv
============================================================
"""
...
# ============================================================
# Config — must match NN_baseline_mnist_angle_layer10.py exactly
# ============================================================
N_QUBITS          = 9
N_LAYERS          = 10
N_CLASSES         = 10
...
DEPO_SUMMARY_CSV = os.path.join(
    DEPO_RUN_DIR, "depo_baseline_mn_ang_l10_summary.csv")

MODEL_CHECKPOINT = "baseline_mnist_angle_layer10/best_model_run1.pt"
...
# ============================================================
# 3. Data — must match NN_baseline_mnist_angle_layer10.py exactly
...
def main():
    ...
    if not os.path.exists(MODEL_CHECKPOINT):
        raise FileNotFoundError(
            ...
            f"Run NN_baseline_mnist_angle_layer10.py first.")
