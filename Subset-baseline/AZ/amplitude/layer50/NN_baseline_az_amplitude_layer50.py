...
Output structure:
  baseline_amplitude_layer50/
    baseline_amplitude_layer50_run1_epoch_metrics.csv
    baseline_amplitude_layer50_run1_metrics.csv
    baseline_amplitude_layer50_summary.csv
    best_model_run1.pt
============================================================
"""
...
OUT_DIR     = "baseline_amplitude_layer50"
SUMMARY_CSV = os.path.join(OUT_DIR, "baseline_amplitude_layer50_summary.csv")
...
def save_epoch_csv(epoch_recs, run_id):
    path = os.path.join(OUT_DIR,
                        f"baseline_amplitude_layer50_run{run_id}_epoch_metrics.csv")
...
def save_per_run_csv(metrics, run_id):
    path = os.path.join(OUT_DIR,
                        f"baseline_amplitude_layer50_run{run_id}_metrics.csv")
    with open(path, "w", newline="") as f:
...
def main():
    ...
    print(SEP)
    print(f"  Baseline | AZ-Class 23-family | 9-qubit | AmplitudeEmbedding | 50 layers")
    ...
    print(f"  Epoch CSV    -> {OUT_DIR}/baseline_amplitude_layer50_run1_epoch_metrics.csv")
    print(f"  Per-run CSV  -> {OUT_DIR}/baseline_amplitude_layer50_run1_metrics.csv")
    print(SEP)
