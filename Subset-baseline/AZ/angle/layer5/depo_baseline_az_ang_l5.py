...
Saved model expected (from NN_baseline_az_angle_layer5.py):
  baseline_layer5/best_model_run1.pt
...
Output folder structure:
  ...
  depo_baseline_runs/
    depo_baseline_az_ang_l5_summary.csv
============================================================
"""
...
# ============================================================
# Config — must match NN_baseline_az_angle_layer5.py exactly
# ============================================================
N_QUBITS          = 9
N_LAYERS          = 5
N_CLASSES         = 23
...
DEPO_SUMMARY_CSV = os.path.join(
    DEPO_RUN_DIR, "depo_baseline_az_ang_l5_summary.csv")

MODEL_CHECKPOINT = "baseline_layer5/best_model_run1.pt"
...
print(f"[Config] N_LAYERS={N_LAYERS}  DEPO_P={DEPO_P}  N_CLASSES={N_CLASSES}")
...
# ============================================================
# 3. Data — must match NN_baseline_az_angle_layer5.py exactly
#    MinMaxScaler -> PCA(9)
# ============================================================
def load_az23_pca9(
...
def save_cm(cm, filepath):
    ...
    ax.set_title(
        ...
        f"Baseline AZ Angle L{N_LAYERS} | Clean model, noisy inference",
        fontsize=11)
...
def main():
    print("=" * 68)
    print(f" Depolarizing Noise Evaluation | Baseline AZ Angle L{N_LAYERS}")
    ...
    if not os.path.exists(MODEL_CHECKPOINT):
        raise FileNotFoundError(
            ...
            f"Run NN_baseline_az_angle_layer5.py first.")
