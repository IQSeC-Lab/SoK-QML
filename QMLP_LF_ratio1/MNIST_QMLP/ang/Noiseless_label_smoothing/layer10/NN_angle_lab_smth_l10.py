...
best_model_prefix = "qmlp-mnist-angle-label-flip-run"
filename_prefix = "qmlp-mnist-angle-label-flip-run"
...
def flip_labels(y, num_classes, flip_fraction=0.1, seed=42):
    np.random.seed(seed)
    y_flipped = y.copy()
    n_samples = len(y)
...
y_train = flip_labels(y_train, num_classes=num_classes, flip_fraction=0.1)
...
# Testing (returns accuracy and loss)
