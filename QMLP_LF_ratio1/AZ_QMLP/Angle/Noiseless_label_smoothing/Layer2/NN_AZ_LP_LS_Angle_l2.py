...
# Training Function (returns epoch loss)
...
class EarlyStoppingAccuracy:
    def __init__(self, patience=5, min_delta=0.001):
        self.patience = patience          # epochs to wait without improvement
        self.min_delta = min_delta        # minimum accuracy gain to count
...
# Training Loop with Early Stopping on accuracy
for run_id in range(1, 4):
    ...
    for epoch in range(1, epochs + 1):
        ...
        # checkpoint best accuracy to disk
        if acc > best_acc:
            best_acc = acc
        ...
        print(
            ...
            f"val_acc={acc:.2f}, best_val_acc={early_stopper.best_acc:.2f}, "
    ...
    # restore best-accuracy model according to early stopper
